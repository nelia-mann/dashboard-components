...
`;class ej extends es{static properties={...super.properties,option:{state:!0}};constructor(){super(),this.option="",this._options=[]}getTriggers(){return["option"]}onFirstUpdate(){this.buildOptions()}getOption(){return this.option}setOption(t){this.option=t}isSelected(t){return this.getOption()===t}getOptions(){return this._options}buildOptions(){let t=["onOff"];this.hasBrightness()&&t.push("brightness"),this.hasCTColor()&&t.push("color_temp_kelvin"),this.hasHSColor()&&t.push("hs_color"),this.hasTheme()&&t.push("theme"),this._options=t}onSelect(t){this.dispatchEvent(new CustomEvent("select",{detail:t}))}getStyles(t){let e={},i="";switch(t){case"brightness":case"theme":e.background=et(tQ,.2),i=et(tQ,1);break;case"color_temp_kelvin":e.background=this.tempGradientFull(),i=this.tempBorder();break;case"hs_color":e.background=this.hsGradient(),i=et(t2,1)}return this.isSelected(t)&&(e.outline="solid "+i),e}iconContent(t){let e;switch(t){case"onOff":e=U`<light-icon
        ...
        `)}static styles=[tX,er];render(){if(this.isInitialized())return U`
                ...
                ${this.lightControl()}
            `}}customElements.define("light-group-control",eP);var eO=a`
...
`;customElements.define("light-component",class extends es{onClick(){let t=this.getMainId(),e=t.split(".")[0];this.callService(e,"toggle",{entity_id:t})}static styles=[tX,eB];render(){if(this.isInitialized())return U`
            ...
            <light-component
                ...
                .callService=${this.callService}
            ></light-component>
        `}static styles=[tX,eV];render(){if(this.isInitialized()){let t=Object.keys(this.getStructure());return U`
