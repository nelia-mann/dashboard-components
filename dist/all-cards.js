...
`;class tN extends to{_changeFlag;static properties={changedEntityIds:{state:!0},states:{state:!0},_initialized:{state:!0}};constructor(){super(),this.changedEntityIds=new Set,this.states={},this._initialized=!1,this.structure={},this.entityIds=new Set,this._changeFlag=!1}update(t){this.getChangeFlag()||this.setInitialValues(),super.update(t)}shouldUpdate(t){return!this.isInitialized()||this.hasRelevantChanges()||t.has("_initialized")||this.updateTrigger(t)}updateTrigger(t){for(let e of this.getTriggers())if(t.has(e))return!0;return!1}firstUpdated(){this.onFirstUpdate(),this.setInitialValues(),this.initialize()}hasRelevantChanges(){return!this.getChangeFlag()&&this.isIntersection(this.getCEIs(),this.getEntityIds())}isIntersection(t,e){for(let i of(t.size>e.size&&([t,e]=[e,t]),t))if(e.has(i))return!0;return!1}waitForEntity(t,e,i=5e3){let s=0;return new Promise((n,r)=>{let a=()=>{if(e.call(this,t))return void n();if((s+=100)>=i){r(Error(`Timed out waiting for ${t}`)),this.setInitialValues();return}setTimeout(a,100)};a()})}isInitialized(){return this._initialized}initialize(){this._initialized=!0}getChangeFlag(){return this._changeFlag}raiseChangeFlag(){this._changeFlag=!0}lowerChangeFlag(){this._changeFlag=!1}getCEIs(){return this.changedEntityIds}getStates(){return this.states}getEntityIds(){return this.entityIds}getStructure(){return this.structure}getState(t){return this.getStates()[t]}getStateEI(t){return t.entity_id}getStateState(t){let e=this.getState(t);if(e)return e.state}getAttributes(t){let e=this.getState(t);if(e)return e.attributes}getAttribute(t,e){let i=this.getAttributes(t);if(i)return i[e]}getName(t){let e=this.getAttributes(t);if(e)return e.friendly_name}makePretty(t){let e=t.split("_"),i="";return e.forEach(t=>{i=i+t.charAt(0).toUpperCase()+t.slice(1)+" "}),i.slice(0,-1)}onFirstUpdate(){}getTriggers(){return[]}setInitialValues(){}}let tU=[255,193,7],tG=[127,97,3],tZ=[158,158,158],tq=[68,115,158],tY=[41,0,255],tJ=[33,150,243],tW=[255,111,34],tX=[110,65,171],tK=[255,255,255],tQ=[0,188,212],t0=[45,100];function t1(t,e,i){return i>1?e:i<0?t:t+(e-t)*i}function t5(t,e){return`rgba(${t[0]}, ${t[1]}, ${t[2]}, ${e})`}function t2(t,e,i){return[t1(t[0],e[0],i),t1(t[1],e[1],i),t1(t[2],e[2],i)]}class t3 extends tN{getMainId(){return this.getStructure().main}getThisStructure(t){return t&&t!==this.getMainId()?this.getGroup()[t].structure:this.getStructure()}isGroup(t){return!!this.getThisStructure(t).group}getGroup(){return this.getStructure().group}getThemeId(t){return this.getThisStructure(t).theme}getLightState(t){return t?this.getState(t):this.getState(this.getMainId())}getThemeState(t){return t?this.getState(this.getThemeId(t)):this.getState(this.getThemeId(this.getMainId()))}getThemeStateState(t){return this.getThemeState(t).state}getAttributes(t){return this.getLightState(t).attributes}getName(t){return this.getAttributes(t).friendly_name}isOn(t){return"on"===this.getLightState(t).state}getRGB(t){return this.getAttributes(t).rgb_color}getOffBrightness(t){let e=this.getAttributes(t).off_brightness;if(e)return e;let i=this.getAttributes(t).entity_id;if(i){let t=[];i.forEach(e=>{let i=this.getAttributes(e).off_brightness;i&&t.push(i)}),t.length>0&&(e=t.reduce((t,e)=>t+e,0)/t.length)}if(e)return e}getBrightnessPct(t){let e=100,i=this.getAttributes(t).brightness,s=this.getOffBrightness(t);return i?e=100*i/255:s&&(e=100*s/255),e}getColorModes(t){let e=this.getAttributes(t).supported_color_modes;return e||[]}hasBrightness(t){return Object.keys(this.getAttributes(t)).includes("brightness")}hasCTColor(t){return Object.keys(this.getAttributes(t)).includes("color_temp_kelvin")}hasHSColor(t){return Object.keys(this.getAttributes(t)).includes("hs_color")}hasTheme(t){return Object.keys(this.getThisStructure(t)).includes("theme")}getThemeOptions(t){return this.getAttributes(this.getThemeId(t)).options}getTheseEntityIds(t){let e,i=[e=t||this.getMainId()];return this.hasTheme(e)&&i.push(this.getThemeId()),new Set(i)}getHalfRGB(t){let e=this.getRGB(t);return[e[0]/2,e[1]/2,e[2]/2]}getColor(t){let e=tq;return this.isOn(t)&&(e=this.getRGB(t)?t2(this.getHalfRGB(t),this.getRGB(t),this.getBrightnessPct(t)/100):t2(tG,tU,this.getBrightnessPct(t)/100)),t5(e,1)}getHSColor(t){let e=t0,i=this.getAttributes(t).hs_color;return i&&(e=i),e}getMinTemp(t){let e=1500,i=this.getAttributes(t).min_color_temp_kelvin;return i&&(e=i),e}getMaxTemp(t){let e=9e3,i=this.getAttributes(t).max_color_temp_kelvin;return i&&(e=i),e}getColorTemp(t){let e=2e3,i=this.getAttributes(t).color_temp_kelvin;return i&&(e=i),e}hsGradient(){let t="radial-gradient(circle at center, white 0%, transparent 100%), ";t+="conic-gradient( from 0deg";for(let e=0;e<=10;e++){let i=Math.round(360*e/10);t+=`, hsl(${i}, 100%, 50%)`}return t+")"}getTempRed(t){let e;return(e=t<=6600?255:Math.round(329.698727446*(e=t/100-60)**-.1332047592))<0&&(e=0),e>255&&(e=255),e}getTempGreen(t){let e;return(e=t<=6600?Math.round(99.4708025861*Math.log(e=t/100)-161.1195681661):Math.round(288.1221695283*(e=t/100-60)**-.0755148492))<0&&(e=0),e>255&&(e=255),e}getTempBlue(t){let e;return(e=t>6600?255:t<=1900?0:Math.round(138.5177312231*Math.log(e=t/100-10)-305.0447927307))<0&&(e=0),e>255&&(e=255),e}getTempColor(t){return[this.getTempRed(t),this.getTempGreen(t),this.getTempBlue(t)]}tempBorder(){return t5(this.getTempColor(1500),1)}tempGradientGeneral(t,e,i,s){let n=`linear-gradient(${i}`;for(let i=0;i<=10;i++){let r=(t*(10-i)+e*i)/10,a=t5(this.getTempColor(r),s),o=Math.round(100*i/10);n=n+", "+a+` ${o}%`}return n+")"}tempGradientFull(){return this.tempGradientGeneral(1500,9e3,"to right",1)}}let t9="important",t4=" !"+t9,t8=tm(class extends tf{constructor(t){if(super(t),1!==t.type||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(let t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ft.add(t);let e="string"==typeof s&&s.endsWith(t4);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?t9:""):i[t]=s}}return U}});var t7="M7.03 13.92H11.03V5L13.04 4.97V13.92H17.03L12.03 18.92Z",t6="M 11,4L 13,4L 13,15L 11,15L 11,4 Z M 13,18L 13,20L 11,20L 11,18L 13,18 Z",et="M12,11A1,1 0 0,0 11,12A1,1 0 0,0 12,13A1,1 0 0,0 13,12A1,1 0 0,0 12,11M12.5,2C17,2 17.11,5.57 14.75,6.75C13.76,7.24 13.32,8.29 13.13,9.22C13.61,9.42 14.03,9.73 14.35,10.13C18.05,8.13 22.03,8.92 22.03,12.5C22.03,17 18.46,17.1 17.28,14.73C16.78,13.74 15.72,13.3 14.79,13.11C14.59,13.59 14.28,14 13.88,14.34C15.87,18.03 15.08,22 11.5,22C7,22 6.91,18.42 9.27,17.24C10.25,16.75 10.69,15.71 10.89,14.79C10.4,14.59 9.97,14.27 9.65,13.87C5.96,15.85 2,15.07 2,11.5C2,7 5.56,6.89 6.74,9.26C7.24,10.25 8.29,10.68 9.22,10.87C9.41,10.39 9.73,9.97 10.14,9.65C8.15,5.96 8.94,2 12.5,2Z",ee="M17.66 11.2C17.43 10.9 17.15 10.64 16.89 10.38C16.22 9.78 15.46 9.35 14.82 8.72C13.33 7.26 13 4.85 13.95 3C13 3.23 12.17 3.75 11.46 4.32C8.87 6.4 7.85 10.07 9.07 13.22C9.11 13.32 9.15 13.42 9.15 13.55C9.15 13.77 9 13.97 8.8 14.05C8.57 14.15 8.33 14.09 8.14 13.93C8.08 13.88 8.04 13.83 8 13.76C6.87 12.33 6.69 10.28 7.45 8.64C5.78 10 4.87 12.3 5 14.47C5.06 14.97 5.12 15.47 5.29 15.97C5.43 16.57 5.7 17.17 6 17.7C7.08 19.43 8.95 20.67 10.96 20.92C13.1 21.19 15.39 20.8 17.03 19.32C18.86 17.66 19.5 15 18.56 12.72L18.43 12.46C18.22 12 17.66 11.2 17.66 11.2M14.5 17.5C14.22 17.74 13.76 18 13.4 18.1C12.28 18.5 11.16 17.94 10.5 17.28C11.69 17 12.4 16.12 12.61 15.23C12.78 14.43 12.46 13.77 12.33 13C12.21 12.26 12.23 11.63 12.5 10.94C12.69 11.32 12.89 11.7 13.13 12C13.9 13 15.11 13.44 15.37 14.8C15.41 14.94 15.43 15.08 15.43 15.23C15.46 16.05 15.1 16.95 14.5 17.5H14.5Z",ei="M16.56,5.44L15.11,6.89C16.84,7.94 18,9.83 18,12A6,6 0 0,1 12,18A6,6 0 0,1 6,12C6,9.83 7.16,7.94 8.88,6.88L7.44,5.44C5.36,6.88 4,9.28 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12C20,9.28 18.64,6.88 16.56,5.44M13,3H11V13H13",es="M20.79,13.95L18.46,14.57L16.46,13.44V10.56L18.46,9.43L20.79,10.05L21.31,8.12L19.54,7.65L20,5.88L18.07,5.36L17.45,7.69L15.45,8.82L13,7.38V5.12L14.71,3.41L13.29,2L12,3.29L10.71,2L9.29,3.41L11,5.12V7.38L8.5,8.82L6.5,7.69L5.92,5.36L4,5.88L4.47,7.65L2.7,8.12L3.22,10.05L5.55,9.43L7.55,10.56V13.45L5.55,14.58L3.22,13.96L2.7,15.89L4.47,16.36L4,18.12L5.93,18.64L6.55,16.31L8.55,15.18L11,16.62V18.88L9.29,20.59L10.71,22L12,20.71L13.29,22L14.7,20.59L13,18.88V16.62L15.5,15.17L17.5,16.3L18.12,18.63L20,18.12L19.53,16.35L21.3,15.88L20.79,13.95M9.5,10.56L12,9.11L14.5,10.56V13.44L12,14.89L9.5,13.44V10.56Z";class en extends t3{getEntityIds(){return new Set([this.getMainId()])}lightbulb(){return this.isGroup()?this.isOn()?"M15 14V16A1 1 0 0 1 14 17H10A1 1 0 0 1 9 16V14A5 5 0 1 1 15 14M14 18H10V19A1 1 0 0 0 11 20H13A1 1 0 0 0 14 19M7 19V18H5V19A1 1 0 0 0 6 20H7.17A2.93 2.93 0 0 1 7 19M5 10A6.79 6.79 0 0 1 5.68 7A4 4 0 0 0 4 14.45V16A1 1 0 0 0 5 17H7V14.88A6.92 6.92 0 0 1 5 10M17 18V19A2.93 2.93 0 0 1 16.83 20H18A1 1 0 0 0 19 19V18M18.32 7A6.79 6.79 0 0 1 19 10A6.92 6.92 0 0 1 17 14.88V17H19A1 1 0 0 0 20 16V14.45A4 4 0 0 0 18.32 7Z":"M20.84 22.73L18.09 20C18.06 20 18.03 20 18 20H16.83C16.94 19.68 17 19.34 17 19V18.89L14.75 16.64C14.57 16.86 14.31 17 14 17H10C9.45 17 9 16.55 9 16V14C7.4 12.8 6.74 10.84 7.12 9L5.5 7.4C5.18 8.23 5 9.11 5 10C5 11.83 5.72 13.58 7 14.88V17H5C4.45 17 4 16.55 4 16V14.45C2.86 13.79 2.12 12.62 2 11.31C1.85 9.27 3.25 7.5 5.2 7.09L1.11 3L2.39 1.73L22.11 21.46L20.84 22.73M15 6C13.22 4.67 10.86 4.72 9.13 5.93L16.08 12.88C17.63 10.67 17.17 7.63 15 6M19.79 16.59C19.91 16.42 20 16.22 20 16V14.45C21.91 13.34 22.57 10.9 21.46 9C20.8 7.85 19.63 7.11 18.32 7C18.77 7.94 19 8.96 19 10C19 11.57 18.47 13.09 17.5 14.31L19.79 16.59M10 19C10 19.55 10.45 20 11 20H13C13.55 20 14 19.55 14 19V18H10V19M7 18H5V19C5 19.55 5.45 20 6 20H7.17C7.06 19.68 7 19.34 7 19V18Z":this.isOn()?"M12,2A7,7 0 0,0 5,9C5,11.38 6.19,13.47 8,14.74V17A1,1 0 0,0 9,18H15A1,1 0 0,0 16,17V14.74C17.81,13.47 19,11.38 19,9A7,7 0 0,0 12,2M9,21A1,1 0 0,0 10,22H14A1,1 0 0,0 15,21V20H9V21Z":"M12,2C9.76,2 7.78,3.05 6.5,4.68L16.31,14.5C17.94,13.21 19,11.24 19,9A7,7 0 0,0 12,2M3.28,4L2,5.27L5.04,8.3C5,8.53 5,8.76 5,9C5,11.38 6.19,13.47 8,14.74V17A1,1 0 0,0 9,18H14.73L18.73,22L20,20.72L3.28,4M9,20V21A1,1 0 0,0 10,22H14A1,1 0 0,0 15,21V20H9Z"}render(){if(this.isInitialized())return N`
    ...
    `]}customElements.define("lighting-button",eb);class eS extends tp{_LABEL="lighting";static properties={...super.properties,_floorId:{state:!0}};hasChanges(t,e,i){return tD(t,e,i)}getTriggers(){return["_floorId"]}setStructure(){Object.keys(this.getHass().floors).forEach(t=>{let e=tM(this.getHass(),this.getEntityIds(),t);if(e.size>0){var i,s;let n={name:(i=this.getHass(),s=t,i.floors[s].name),structure:{},entityIds:e};tH(this.getHass(),n),tO(this.getHass(),n),this.getStructure()[t]=n}})}initializeChoice(){let t=Object.keys(this.getStructure());this.setFloorId(t[0])}setFloorId(t){this._floorId=t}getFloorStructure(t){return this.getStructure()[t].structure}getFloorName(t){return this.getStructure()[t].name}getSoloLightIds(t){return this.getStructure()[t].buttonInfo}getFloorId(){return this._floorId}isFloor(t){return this.getFloorId()===t}getThisFloorStructure(){return this.getFloorStructure(this.getFloorId())}getThisFloorEntityIds(){return this.structure[this.getFloorId()].entityIds}onClick(t){this.setFloorId(t)}floorButton(t){return N`
            <lighting-button
                .changedEntityIds = ${this.getCEIs()}
                .states = ${this.getStates()}
    ...
    `;class eT extends tN{getEntityId(t){return this.getStructure()[t]}getNumberState(t){if(this.getEntityId(t))return Number(this.getStateState(this.getEntityId(t)))}getNumberAttribute(t,e){let i=this.getAttribute(this.getEntityId(t),e);if("number"==typeof i)return i}getMainEntityId(){return this.getEntityId("hp")?this.getEntityId("hp"):this.getEntityId("thermostat")?this.getEntityId("thermostat"):this.getEntityId("hygrostat")?this.getEntityId("hygrostat"):void 0}getThisName(){return this.getName(this.getMainEntityId())}getTarget(){return this.getEntityId("hygrostat")?this.getAttribute(this.getMainEntityId(),"humidity"):this.getAttribute(this.getMainEntityId(),"temperature")}getMinExtreme(){return this.getEntityId("hygrostat")?this.getAttribute(this.getMainEntityId(),"min_humidity"):this.getAttribute(this.getMainEntityId(),"min_temp")}getMaxExtreme(){return this.getEntityId("hygrostat")?this.getAttribute(this.getMainEntityId(),"max_humidity"):this.getAttribute(this.getMainEntityId(),"max_temp")}getSeparation(){return this.getEntityId("hygrostat")?1:this.getAttribute(this.getMainEntityId(),"target_temp_step")}getSensor(){return this.getEntityId("hygrostat")?this.getAttribute(this.getMainEntityId(),"current_humidity"):this.getAttribute(this.getMainEntityId(),"current_temperature")}getSensorUnits(){return this.getEntityId("hygrostat")?"%":"°F"}getSensorDisplay(){return this.getSensor().toFixed(1).toString()+" "+this.getSensorUnits()}getMode(){return this.getStateState(this.getMainEntityId())}getModes(){let t;if(this.getEntityId("hygrostat"))return["off","on"];let e=[...this.getAttribute(this.getMainEntityId(),"hvac_modes")];return e.includes("heat_cool")&&(t=e.indexOf("auto"))>-1&&e.splice(t,1),(t=e.indexOf("dry"))>-1&&e.splice(t,1),(t=e.indexOf("fan_only"))>-1&&e.splice(t,1),e}getActionDefault(){return"off"===this.getMode()?"off":this.getTarget()>this.getSensor()?"heating":"idle"}getAction(){let t;return this.getEntityId("hygrostat")?t=this.getAttribute(this.getEntityId("hygrostat"),"action"):(t=this.getAttribute(this.getMainEntityId(),"hvac_action"))||(t=this.getActionDefault()),("fan"===t||"drying"===t)&&(t="venting"),t.charAt(0).toUpperCase()+t.slice(1)}getSafeMin(){return this.getNumberState("safe_min")}getSafeMax(){return this.getNumberState("safe_max")}isSafe(){return"on"===this.getStateState(this.getEntityId("safe_mode"))}getRank(){return Number(this.getStateState(this.getEntityId("rank")))}isDominant(){return 1===this.getRank()}getRankId(){return this.getEntityId("rank")}getScriptId(){return this.getEntityId("script")}getTie(){return this.getStateState(this.getEntityId("tie_main"))}getTieId(){return this.getEntityId("tie_main")}getTieOptions(){return this.getAttribute(this.getEntityId("tie_main"),"options")}getTieAction(){let t=this.getAttribute(this.getEntityId("tie"),"hvac_action");return"fan"===t&&(t="venting"),t.charAt(0).toUpperCase()+t.slice(1)}getTieMode(){return this.getStateState(this.getEntityId("tie"))}getOffsetId(){return this.getEntityId("offset")}getOffset(){return this.getNumberState("offset")}getMinOffset(){return this.getNumberAttribute("offset","min")}getMaxOffset(){return this.getNumberAttribute("offset","max")}}function eM(t,e,i){let s={};switch(t){case"off":s["background-color"]=t5(tZ,.5),i&&(s.outline=`solid ${t5(tZ,1)}`);break;case"heat":case"safe_min":s["background-color"]=t5(tW,.5),i&&(s.outline=`solid ${t5(tW,1)}`);break;case"cool":s["background-color"]=t5(tJ,.5),i&&(s.outline=`solid ${t5(tJ,1)}`);break;case"heat_cool":case"auto":s.background="linear-gradient(to left, "+t5(tJ,.5)+"0%, "+t5(tK,.5)+"50%, "+t5(tW,.5)+"100%)",i&&"Heating"===e&&(s.outline=`solid ${t5(tW,1)}`),i&&"Cooling"===e&&(s.outline=`solid ${t5(tJ,1)}`),i&&["Off","Idle"].includes(e)&&(s.outline=`solid ${t5(tZ,1)}`);break;case"on":case"fan_only":case"safe_max":s["background-color"]=t5(tQ,.5),i&&(s.outline=`solid ${t5(tQ,1)}`)}return s}class eL extends eT{static properties={...super.properties,isSelected:{state:!0}};constructor(){super(),this.isSelected=!1,this.title=""}getTriggers(){return["isSelected"]}selected(){return this.isSelected}getTitle(){return this.title}onClick(){this.dispatchEvent(new CustomEvent("select"))}render(){if(this.isInitialized())return N`
                ...
                </div>`}getStyles(){return eM(this.getMode(),this.getAction(),this.selected())}static styles=[tR,r`
    ...
    `]}customElements.define("climate-button",eL);class ez extends eT{selectMode(t){let e=this.getEntityId("hp");this.callService("climate","set_hvac_mode",{entity_id:e,hvac_mode:t})}setDominant(){let t={entity_id:this.getScriptId(),variables:{heatpump_entity:this.getEntityId("hp")}};this.callService("script","turn_on",t)}modeButton(t){let e;switch(t){case"off":e=N`<ha-svg-icon .path=${ei}/>`;break;case"heat":e=N`<ha-svg-icon .path=${ee}/>`;break;case"cool":e=N`<ha-svg-icon .path=${es}/>`;break;case"heat_cool":case"auto":e=N`
        ...
        `}dominateButton(){if(this.getRank())return N`
                ...
                ${this.modeButtons()}
                ${this.dominateButton()}
            `}getModeStyles(t){let e=t===this.getMode();return eM(t,this.getAction(),e)}getDomStyles(){return eM(this.getMode(),this.getAction(),this.isDominant())}static styles=[tR,r`
    ...
    `]}customElements.define("heatpump-panel",eB);class eO extends eT{getRegionName(){return this.regionName}isTied(){return[this.getRegionName(),"on"].includes(this.getTie())}getAreaMode(){return this.areaMode}getAreaAction(){return this.areaAction}selectMode(t){this.isTied()&&this.selectTie();let e=this.getEntityId("thermostat");this.callService("climate","set_hvac_mode",{entity_id:e,hvac_mode:t})}selectTie(){let t={entity_id:this.getTieId()};if(this.getTieOptions()){let e=this.getRegionName();this.isTied()&&(e="off"),t.option=e,this.callService("input_select","select_option",t)}else this.callService("input_boolean","toggle",t)}setSafe(){let t=this.getEntityId("safe_mode");this.callService("input_boolean","toggle",{entity_id:t})}modeButton(t){let e;switch(t){case"off":e=N`<ha-svg-icon .path=${ei}/>`;break;case"heat":e=N`<ha-svg-icon .path=${ee}/>`;break;case"safe_min":e=N`
        ...
        >
            ...
            ${this.makePretty(this.getRegionName())}
                ...
                ${this.safeButton()}
                ${this.TieButton()}
            `}getModeStyles(t){let e=t===this.getMode();return eM(t,this.getAction(),e)}getTieStyles(){return eM(this.getAreaMode(),this.getAreaAction(),this.isTied())}getSafeStyles(){return eM("safe_min",this.getAction(),this.isSafe())}static styles=[tR,r`
    ...
    `]}customElements.define("hydrostat-panel",eF);class eR extends eT{selectMode(t){let e={entity_id:this.getEntityId("hygrostat")};"on"===t?this.callService("humidifier","turn_on",e):"off"===t&&this.callService("humidifier","turn_off",e)}setSafe(){let t=this.getEntityId("safe_mode");this.callService("input_boolean","toggle",{entity_id:t})}modeButton(t){let e;switch(t){case"off":e=N`<ha-svg-icon .path=${ei}/>`;break;case"on":e=N`<ha-svg-icon .path=${et}/>`}return N`<div class="button outlined"
        ...
        `}safeButton(){if(this.getEntityId("safe_mode"))return N`<div class="button outlined"
            ...
            >
                ...
                ${this.modeButtons()}
                ${this.safeButton()}
            `}getModeStyles(t){let e=t===this.getMode();return eM(t,this.getAction(),e)}getSafeStyles(){return eM("safe_max",this.getAction(),this.isSafe())}static styles=[tR,r`
...
`]}customElements.define("player-panel",ir);class ia extends e6{static properties={...super.properties,entityIds:{state:!0},selected:{type:Boolean}};getTriggers(){return["entityIds","selected"]}updated(t){super.updated(t),Object.assign(this.style,this.getStyles())}getRGB(t){return this.isPlaying()?t5(t2(tZ,tX,this.getAverageVolume()),t):t5(tZ,t)}isSelected(){return this.selected}handlePointerDown(t,e){this._debugLog("handlePointerDown inside group-panel fires");let i=t.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("speaker-drag-start",{detail:{speakerId:e,pointerId:t.pointerId,clientX:t.clientX,clientY:t.clientY,width:i.width,height:i.height}}))}speakerTile(t){return N`
            <speaker-tile
                .changedEntityIds = ${this.getCEIs()}
                .entityIds = ${new Set([t])}
                .states = ${this.getStates()}
                ...
                .callService = ${this.callService}
            />`}_debugLog(t){this._debugMessages=[...this._debugMsgs||[],t]}playerTile(){return N`
            <div class="player">
                    <div>
                        ${(this._debugMessages||[]).map(t=>N`<div>${t}</div>`)}
                    </div>
    ...
    `]}customElements.define("speaker-group-panel",ia);class io extends e6{_ghost;_suppressDrag;_draggedSpeakerId;_pointerDownTime;static properties={...super.properties,players:{state:!0},selectedPlayer:{state:!0}};constructor(){super(),this.players={},this._ghost=null,this.selectedPlayer=null,this._suppressDrag=!1}getTriggers(){return["players","selectedPlayer"]}onFirstUpdate(){this.initializeSelectedPlayer()}setInitialValues(){this.initializePlayers()}initializePlayers(){let t={};this.getSpeakerIds().forEach(e=>{this.isLeader(e)&&(t[e]=this.getGroup(e))}),this.setPlayers(t)}initializeSelectedPlayer(){let t=Object.keys(this.getPlayers()).map(t=>{let e=this.getPlayer(t).length;return[t,e]});t.sort((t,e)=>e[1]-t[1]),this.setSelectedPlayer(t[0][0])}getSelectedPlayer(){return this.selectedPlayer}setSelectedPlayer(t){this.selectedPlayer=t,this.dispatchEvent(new CustomEvent("select",{detail:t}))}isSelected(t){return t===this.getSelectedPlayer()}getSuppressState(){return this._suppressDrag}raiseSuppress(){this._suppressDrag=!0}lowerSuppress(){this._suppressDrag=!1}getDraggedId(){return this._draggedSpeakerId}setDraggedId(t){this._draggedSpeakerId=t}getPlayers(){return{...this.players}}setPlayers(t){this.players=t}getPlayer(t){return[...this.getPlayers()[t]]}checkGroup(t,e){return t.length===e.length&&t.every(t=>e.includes(t))}isUnjoined(t,e){let i=this.getPlayer(e);return i.every(t=>this.checkGroup(i,this.getGroup(t)))&&this.isAlone(t)}isJoined(t,e){let i=this.getPlayer(e);return i.every(t=>this.checkGroup(i,this.getGroup(t)))}getLeader(t){return this.getGroup(t)[0]}isLeader(t){return t===this.getLeader(t)}removeFromPlayer(t){let e=this.getLeader(t),i=this.getPlayer(e).filter(e=>e!==t),s=this.getPlayers();if(i.length>0?s[e]=i:delete s[e],this.setPlayers(s),i.length>0)return e}addToPlayer(t,e){let i=this.getPlayer(e);i.push(t);let s=this.getPlayers();s[e]=i,this.setPlayers(s),this.setSelectedPlayer(e)}unJoinLeader(t){let e=this.getGroup(t);if(e&&e.length>1){let i=e.filter(e=>e!==t),s=i[0],n=i.filter(t=>t!==s);this.callService("music_assistant","transfer_queue",{entity_id:s,source_player:t}),this.callService("media_player","join",{entity_id:s,group_members:n})}}unJoinFollower(t){this.callService("media_player","unjoin",{entity_id:t})}async unJoinSpeaker(t,e){this._debugLog(t),e&&t&&(this.raiseChangeFlag(),this.isLeader(t)?this.unJoinLeader(t):this.unJoinFollower(t),await this.waitForEntity(t,t=>this.isUnjoined(t,e)),this.lowerChangeFlag(),console.log("done unjoining"))}async joinSpeaker(t,e){this.raiseChangeFlag(),this.callService("media_player","join",{entity_id:e,group_members:[t]}),await this.waitForEntity(t,t=>this.isJoined(t,e)),this.lowerChangeFlag(),console.log("done joining")}handleSelect(t,e){this.setSelectedPlayer(e)}handlePointerDown(t,e){this.getSuppressState()||(t.currentTarget.setPointerCapture(t.pointerId),this.createGhost(e),this.setDraggedId(e.speakerId),this.moveGhost(e.clientX,e.clientY))}handlePointerMove(t){this.getSuppressState()||this.moveGhost(t.clientX,t.clientY)}handlePointerUp(t,e){if(!this.getSuppressState()){let i,s=this.getDraggedId();this.removeGhost(),i=t.clientX&&t.clientY?this.renderRoot.elementFromPoint(t.clientX,t.clientY):this.renderRoot.elementFromPoint(t.detail.x,t.detail.y);let n=Array.from(this.renderRoot.querySelectorAll("[data-group-player")).find(t=>t.contains(i)),r=null;n&&(r=n.dataset.groupPlayer),this.manipulateSpeaker(s,e,r)}}manipulateSpeaker(t,e,i){e!==i&&(null!==i?this.transferSpeaker(t,i):this.getPlayer(e).length>1&&this.removeSpeaker(t))}async transferSpeaker(t,e){let i=this.removeFromPlayer(t);this.addToPlayer(t,e),await this.unJoinSpeaker(t,i),await this.joinSpeaker(t,e)}async removeSpeaker(t){let e=this.removeFromPlayer(t);await this.unJoinSpeaker(t,e)}createGhost(t){this._ghost=document.createElement("speaker-tile"),this._ghost.entityIds=new Set([t.speakerId]),this._ghost.states=this.getStates(),Object.assign(this._ghost.style,{position:"fixed",pointerEvents:"none",opacity:"0.7",zIndex:"1000",width:t.width+"px",height:t.height+"px"}),document.body.appendChild(this._ghost)}moveGhost(t,e){this._ghost&&Object.assign(this._ghost.style,{left:t+"px",top:e+"px",transform:"translate(-50%, -50%)"})}removeGhost(){this._ghost?.remove(),this._ghost=null}_debugLog(t){this._debugMessages=[...this._debugMsgs||[],t]}playerTile(t){let e=this.getPlayer(t);if(e.length>0)return N`
                            <div>
                    ${(this._debugMessages||[]).map(t=>N`<div>${t}</div>`)}
                </div>
                <speaker-group-panel
                    ...
                    .callService = ${this.callService}
                />`}render(){if(this.isInitialized()){let t=Object.keys(this.getPlayers());return N`
            ${tC(t,t=>t,t=>this.playerTile(t))}`}}static styles=[tR,r`
